...
public class ExampleTest_Ext {
	...
	public void testAll() {
		...
		recipe1.addIngredient("Pasta", 70).addIngredient("Nutella", 30);
		...
		r1_menu1.addRecipe("Pasta and Nutella", 50).addProduct("Crackers");
		...
		r2_menu3.addRecipe("Pasta al Ragu", 320).addProduct("Wine 0.5l").addProduct("Biscuits").addProduct("Amaro");
		...
		assertEquals(r1.ordersWithStatus(OrderStatus.DELIVERED).trim(),
				"Napoli, Judi Dench : (19:00):\n\tM6->1\nNapoli, Ralph Fiennes : (19:00):\n\tM1->2\n\tM6->1");
		assertEquals(r2.ordersWithStatus(OrderStatus.READY).trim(), "Roma, Maggie Smith : (08:45):\n\tM3->4\n\tM5->3");
		assertEquals(r3.ordersWithStatus(OrderStatus.ORDERED).trim(),
				"Venezia, Maggie Smith : (12:30):\n\tM1->1\n\tM4->2");
		assertEquals(r4.ordersWithStatus(OrderStatus.ORDERED).trim(),
				"Milano, Ian McKellen : (20:30):\n\tM2->1\n\tM4->2\n\tM5->1");
