...
public class Food {
	...
	private SortedMap<String, NutritionalElement> elencoMateriePrime = new TreeMap<>();
	private SortedMap<String, NutritionalElement> elencoProdotti = new TreeMap<>();
	private SortedMap<String, NutritionalElement> elencoRicette = new TreeMap<>();
	private SortedMap<String, NutritionalElement> elencoMenu = new TreeMap<>();
	...
	public Recipe createRecipe(String name) {
		...
		elencoRicette.put(name, ricetta);
		return ricetta;
	}
	...
	public Menu createMenu(String name) {
		...
		elencoMenu.put(name, menu);
		return menu;
	}
	
	public NutritionalElement getMenu(String name) {
		return elencoMenu.get(name);
	}
	
	public Restaurant defineRestaurant(String name) {
		Restaurant ristorante = new Restaurant(name, this);
		return ristorante;
	}
